...
const Projects = () => {
    const projects = [
        { appType: "Trivia Game", projectName: "Dumbfounded", summary: "Test your knowledge with this fun trivia game! Play multiplayer either locally or online, or single player and try to be listed on the highscores.", technologies: ["HTML", "CSS",  "React", "Redux", "axios", "Javascript", "Jest", "Socket.io", "PostgreSQL"], github: [{ linkFor: "Backend", link: "https://github.com/Gioele-M/lap3_quiz_project_server"}, { linkFor: "Frontend", link: "https://github.com/Gioele-M/lap3_quiz_project_client"}], deploy: "https://dumbfounded.netlify.app/", img: dumbfounded},
        { appType: "Habit Tracker", projectName: "Atomic Addicts", summary: "This app is for tracking and managing habits, with five key habits to choose from: sleeping, exercise, water intake, smoking, and savings.", technologies: ["HTML", "CSS", "JavaScript", "Jest","Node.js", "Express", "PostgreSQL", "Bcrypt", "JSON Web Token", "Docker"], github: [{ linkFor: "Backend + Frontend", link: "https://github.com/LaylaSouthcombe/lap2project"}], deploy: "https://atomic-addicts.netlify.app/", img: atomicaddicts},
        { appType: "Anonymous Post Site", projectName: "OpenUp", summary: "A place to OpenUp to and reach out to other people to gain perspective and find solutions to issues that are troubling you.", technologies: ["HTML", "CSS", "Bootstrap", "JavaScript", "Node.js", "Express", "Heroku"], github: [{ linkFor: "Backend", link: "https://github.com/alihamedali96/OpenUpServer"}, { linkFor: "Frontend", link: "https://github.com/alihamedali96/OpenUpClient"}], deploy: "https://openup-fp.netlify.app/", img: OpenUpImage},
