...
const Projects = () => {
    const projects = [
        { id: 1, appType: "Trivia Game", projectName: "Dumbfounded", summary: "Test your knowledge with this fun trivia game! Play multiplayer either locally or online, or single player and try to be listed on the highscores.", technologies: ["HTML", "CSS",  "React", "Redux", "axios", "Javascript", "Jest", "Socket.io", "PostgreSQL"], github: [{ linkFor: "Backend", link: "https://github.com/Gioele-M/lap3_quiz_project_server"}, { linkFor: "Frontend", link: "https://github.com/Gioele-M/lap3_quiz_project_client"}], deploy: "https://dumbfounded.netlify.app/", img: dumbfounded},
