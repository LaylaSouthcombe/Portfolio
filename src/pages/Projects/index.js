...
const Projects = () => {
    const projects = [
        ...
        { appType: "Habit Tracker", projectName: "A1 Habits", summary: "This app is for tracking and managing habits, with five key habits to choose from: sleeping, exercise, water intake, smoking, and savings.", technologies: ["HTML", "CSS", "JavaScript", "Jest","Node.js", "Express", "PostgreSQL", "Bcrypt", "JSON Web Token", "Docker"], github: [{ linkFor: "Backend + Frontend", link: "https://github.com/LaylaSouthcombe/lap2project"}], deploy: "https://atomic-addicts.netlify.app/", img: atomicaddicts},
