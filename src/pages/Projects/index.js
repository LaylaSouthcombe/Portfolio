...
const Projects = ({innerRef}) => {
    ...
    const projects = [
        ...
        { id: 2, appType: "Habit Tracker", projectName: "Indee", summary: "A React full-stack app with a MongoDB database that aims to help people live more independently through tracking habits which can be viewed by a carer/guardian also", technologies: ["HTML", "CSS", "JavaScript", "Node.js", "Express", "PostgreSQL", "Heroku", "Bcrypt", "Chart.js", "Docker"], github: [{ linkFor: "Back-end", link: "https://github.com/LaylaSouthcombe/Indee_backend"}, { linkFor: "Front-end", link: "https://github.com/LaylaSouthcombe/Indee_frontend"}], deploy: "https://indee.netlify.app/", img: indee},
        { id: 3, appType: "Meal Planner Site", projectName: "Sooki", summary: "A React full-stack app with a Python backend and SQL database to generate a random meal plan that takes in your dietary requirements and budget, and can generate a shopping list for you (group project)", technologies: ["HTML", "CSS",  "React", "Redux", "axios", "JavaScript", "Jest", "Python", "PyMongo", "Django", "pytest", "PostgreSQL", "Bcrypt"], github: [{ linkFor: "Back-end", link: "https://github.com/LaylaSouthcombe/meal_planner_backend"}, { linkFor: "Front-end", link: "https://github.com/LaylaSouthcombe/meal_planner_frontend"}], deploy: "https://digerati-meal-planner.netlify.app/", img: sooki}
    ]
