    ...
    return(
       <div className="sectionDiv" id="skills">
            ...
            <div className="skillsIcons">
                ...
                <div class="item2 item"><img className="icon" src={cssIcon} alt="" />
                <div className="bottomBorder bb2"></div></div>
                <div class="item3 item"><img className="icon" src={jsIcon} alt="" />
                <div className="bottomBorder bb3"></div></div>  
                <div class="item4 item"><img className="icon" src={reactIcon} alt="" />
                <div className="bottomBorder bb4"></div></div>
                <div class="item5 item"><img className="icon" src={pythonIcon} alt="" />
                <div className="bottomBorder bb5"></div></div>
                <div class="item6 item"><img className="icon" src={nodeIcon} alt="" />
                <div className="bottomBorder bb6"></div></div>
                <div class="item7 item"><img className="icon" src={jestIcon} alt="" />
                <div className="bottomBorder bb7"></div></div>
                <div class="item8 item"><img className="icon" src={dockerIcon} alt="" />
                <div className="bottomBorder bb8"></div></div>
                <div class="item9 item"><img className="icon" src={flaskIcon} alt="" />
                <div className="bottomBorder bb9"></div></div>
                <div class="item10 item"><img className="icon" src={herokuIcon} alt="" />
                <div className="bottomBorder bb10"></div></div>
                <div class="item11 item"><img className="icon" src={mongoIcon} alt="" />
                <div className="bottomBorder bb11"></div></div>
                <div class="item12 item"><img className="icon" src={postgresIcon} alt="" />
